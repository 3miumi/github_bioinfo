...
def main(args):
    ...
    if opts.species == "Salmonella" or opts.species == "salmonella":
        ...
        mashCommend ="mash dist /mnt/data2/FDA/assemblies/Mash_database_latest/lm/lm_011122_all.msh *.contigs.fasta > output.tab"
    elif opts.species == "Ecoli" or opts.species == "ecoli":
        mashCommend = " mash dist /mnt/data2/FDA/assemblies/ecoli_mash_one/ecoli_all.msh *.contigs.fasta > output.tab"
